...
```groovy
dependencies {
    compile 'com.cookingfox:lapasse:0.3.8'
}
```
...
- [LaPasse (core)](http://www.javadoc.io/doc/com.cookingfox/lapasse/0.3.8)
- [LaPasse Rx extension](http://www.javadoc.io/doc/com.cookingfox/lapasse-rx/0.3.8)
- [LaPasse Compiler (annotation processor)](http://www.javadoc.io/doc/com.cookingfox/lapasse-compiler/0.3.8)
