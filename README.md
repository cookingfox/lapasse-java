...
```groovy
dependencies {
    compile 'com.cookingfox:lapasse:0.5.2'
}
```
...
- [LaPasse (core)](http://www.javadoc.io/doc/com.cookingfox/lapasse/0.5.2)
- [LaPasse Rx extension](http://www.javadoc.io/doc/com.cookingfox/lapasse-rx/0.5.2)
- [LaPasse Compiler (annotation processor)](http://www.javadoc.io/doc/com.cookingfox/lapasse-compiler/0.5.2)
